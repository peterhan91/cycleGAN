...
from models.model import Generator2Dto3D
...
parser.add_argument('--generator_A2B', type=str, default='output/best/netG_A2B.pth', help='A2B generator checkpoint file')
...
dataloader = DataLoader(TestDataset(opt.dataroot, transforms_=transforms_, mode='test'), 
...
for i, batch in enumerate(dataloader):
    ...
    save_dicom(fake_B, os.path.join(os.path.dirname(path_A), 'generated_ct.dcm'))
